...
namespace Mango.Services.AuthAPI.Controllers
{
    ...
    public class AuthAPIController : ControllerBase
    {
        ...
        public async Task<IActionResult> Register([FromBody] RegistrationRequestDto registrationRequestDto)
        {
            ...
            //await _messageBus.PublicMessage(registrationRequestDto.Email, _configuration.GetValue<string>("TopicAndQueueNames:RegisterUserQueue"));
            _rabbitMQAuthMessageSender.SendMessage(registrationRequestDto.Email, _configuration.GetValue<string>("TopicAndQueueNames:RegisterUserQueue"));
            return Ok(_response);
        }
